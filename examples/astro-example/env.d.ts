...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'REQUIRED_ITEM' | 'APP_ENV' | 'PUBLIC_FOO' | 'VITE_PUBLIC_FOO' | 'VITE_ENV_SPECIFIC_ITEM' | 'ENV_SPECIFIC_ITEM' | 'ITEM1' | 'VITE_ITEM1'>> {}
}
